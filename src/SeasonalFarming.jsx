...
const SeasonalFarming = ({ setCurrentPage }) => {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-col gap-3 w-full md:flex-row md:w-auto md:gap-3">
            <button 
              ...
              className="bg-amber-600 text-white font-bold py-2.5 px-4 rounded-lg hover:bg-amber-700 transition active:scale-95 w-full md:w-auto"
            >
              Hire an Expert
            </button>
            <button onClick={() => setCurrentPage('blank')} className="border border-amber-600 text-amber-700 font-bold py-2.5 px-4 rounded-lg hover:bg-amber-50 transition active:scale-95 w-full md:w-auto">
              Ask a Question
            </button>
          </div>
        </div>
